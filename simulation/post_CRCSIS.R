...
## PostCRCSIS
##
#       function simulating post-screening result for CRCSIS in Table 4
#
...
PostCRCSIS <- function(sim = 200,n = 200,p = 3000,Caseset = 1){
  set.seed(1234)
  ...
  while(m<= sim){
    try({
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'CRCSIS.csv',sep = '')
      ...
      nam_la = names(betala)
      # compute C
      las[m,1] = length(intersect(nam_la,T_sett)) #C
      # compute IC
      las[m,2] = length(setdiff(nam_la,T_sett)) # IC
      # compute C-fit
      las[m,3] = ifelse(las[m,1] == s&las[m,2] == 0,1,0) #C-fit
      las_beta = rep(0,p)
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'+CRCSIS+LASSO.csv',sep = '')
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'+CRCSIS+SCAD.csv',sep = '')
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'+CRCSIS+MCP.csv',sep = '')
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'+CRCSIS+Oracle.csv',sep = '')
      ...
      filenames = paste("./simulation/Table4/",'n',n,'+','p',p,'+','Case',Caseset,'+CRCSIS+Average.csv',sep = '')
